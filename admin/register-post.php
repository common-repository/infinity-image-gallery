...
<input class="button-primary" id="add_image_to_gallery" type="submit" name="add_image_to_gallery"
	...
	<a class="button-secondary" id="preview_gallery" type="button" name="preview_gallery" href="https://robiulawal40.github.io/infinity-image-gallery/templates/index-5.html" target="_blank"><?php esc_attr_e( 'Preview Gallery' ); ?>" </a>
		<?php
		echo '</div></div>';
